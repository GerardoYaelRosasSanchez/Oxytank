...
public class registrarComercio_Ubicacion_ extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRegistrarComercioUbicacion3Binding.inflate(getLayoutInflater());
